export default function html() {
  ...
  <p>While my title was theoretically CXO, the reality was that the product team was only me and our backend engineer, James Hunt. As a result, my role shifted a lot over the course of the project, so I'll break it down into the following:</p>
  <ul>
    <li>
