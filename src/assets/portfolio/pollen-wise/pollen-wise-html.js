...
<p>When I first met the founders of Pollen Wise, they had a clunky MVP that was built in Unity. The app was released on a trial basis the previous year, showing high enough demand to attract investment capital, but growth had stagnated and churn was high. It only had a few mediocre reviews on the App Store and Google Play.</p>
<p>My job was to transform the app into an elegant, modern application that clearly conveyed complex information. Our top priority was to reduce churn so they could expand to a wider audience. For starters, that meant advising them on how to turn their vision into a new and improved MVP and talking to allergy suffers to understand their needs. From there, we iterated on designs until consensus was reached among stakeholders, before developing the rebuilt app in Flutter.</p>
...
<p>In developing the Flutter app, the cofounders felt it was important to use a cross-platform framework, which is what led them to use Unity before I arrived. Ultimately, I convinced them to use Flutter, even though it meant their existing developer — then a college student — had to learn it from scratch. Over the next few months, I would mentor that developer on Flutter development and general programming practices, and everyone has since agreed that Flutter was one of the best decisions we made.</p>
